...
<template>
    ...
    <!-- 顶部标题 -->
    <div>
      <div id="title">Log Management</div>
      <br>
    </div>
    ...
    <el-table :data="tableData" border style="width: 100%" fit size="small">
      ...
      <el-table-column prop="operateTime" label="Operation Time" align="center" width="150px"/>
      ...
      <el-table-column prop="costTime"  label="Execution Time (ms)" align="center" width="100px"/>
      <el-table-column prop="methodParams" label="Request Parameters" align="center" width="280px">
      ...
      <el-table-column prop="returnValue"  label="Return Val" align="center"></el-table-column>
    </el-table>
    <br>
